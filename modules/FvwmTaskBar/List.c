...
******************************************************************************/
// 2017-04-09 DWF
// FvwmTaskBar.c used the count field of item as a unique ID, which it was
// not because it was never even initialized.  Added count parameter as with
// AddItem.
void AddItemName(List *list, char *string, long flags, int count) {
  Item *new;
...
Item *temp;
  ...
  // 2017-04-11 DWF Synchronized heading with what actually is printed.
  ConsoleMessage("   %10s %-15s Flgs\n","ID","Name");
  ConsoleMessage("   ---------- --------------- ----\n");
