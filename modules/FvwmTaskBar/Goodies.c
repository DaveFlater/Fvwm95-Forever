...
void InitGoodies() {
  ...
  goodies_width += 5;   // 2017-04-11 DWF reduced from 7 to fix asymmetry
...
void DrawGoodies() {
  ...
  // 2017-04-12 DWF  This smells like brute force and frustration, but
  // CheckLockModule and MailCheckModule don't work right without it.  Just
  // moving RedrawWindow(1) to the bottom isn't enough when icons are
