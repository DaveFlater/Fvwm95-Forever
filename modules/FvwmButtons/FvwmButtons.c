...
void DeadPipe(int whatever)
{
  ...
  /* DWF 2013-09-01:  I was getting SIGHUP from XSync and it was infinite
     looping.  If any of these other signals reoccur while we are in this
     function, we should take the hint and just exit. */
		...
		if(strncasecmp(act,"Exec",4)==0)
		  {
		    ...
		    tmp=mymalloc(strlen(act)+2); // DWF +2 2017-03-04
		    strcpy(tmp,"Exec ");
